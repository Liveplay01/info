...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/typing/spiel',      label: 'Tipp-Spiel',           tag: '⟨type/⟩',  tagColor: 'text-emerald-500 dark:text-emerald-400', desc: 'Minigame', isGame: true },
      { href: '/shortcuts',              label: 'Windows Shortcuts',    tag: '⟨keys/⟩',  tagColor: 'text-violet-500 dark:text-violet-400',   desc: '56 Shortcuts' },
      { href: '/shortcuts/trainer',      label: 'Shortcut-Trainer',     tag: '⟨keys/⟩',  tagColor: 'text-violet-500 dark:text-violet-400',   desc: 'Quiz-Spiel', isGame: true },
      { href: '/shortcuts/rush',         label: 'Shortcut Rush',        tag: '⟨keys/⟩',  tagColor: 'text-violet-500 dark:text-violet-400',   desc: 'Workflow-Shortcuts', isGame: true },
      ...
      { href: '/pc/desktop-cleanup',     label: 'Desktop Cleanup',      tag: '⟨pc/⟩',    tagColor: 'text-amber-500 dark:text-amber-400',     desc: 'Ordnen & organisieren', isGame: true },
  ...
  },
  {
    ...
    items: [
      { href: '/games',                  label: 'Spielhalle',          tag: '⟨games/⟩', tagColor: 'text-violet-500 dark:text-violet-400',   desc: 'Alle 6 Minigames & Skill-Übersicht' },
